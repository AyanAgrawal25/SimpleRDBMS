...
void MatrixCatalogue::renameMatrix(string renameFromMatrixName, string renameToMatrixName) {
    logger.log("MatrixCatalogue::renameMatrix");
    Matrix* matrix = this->matrices[renameFromMatrixName];
    this->matrices.erase(renameFromMatrixName);
    this->matrices[renameToMatrixName] = matrix;
}
